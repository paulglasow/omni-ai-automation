...
export default function Settings() {
  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '32px 24px' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '4px', color: '#222' }}>
        Settings
      </h1>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
          <h2 style={{ fontSize: '0.85rem', color: '#888', textTransform: 'uppercase', letterSpacing: '0.5px', margin: 0 }}>
          ...
          {PROVIDERS.map((p, i) => (
            <div
              ...
              style={{
                ...
                alignItems: 'center',
                padding: '14px 18px',
                borderBottom: i < PROVIDERS.length - 1 ? '1px solid #f0f0f0' : 'none',
              }}
            >
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <div style={{ background: '#fff', border: '1px solid #e8e8e8', borderRadius: '12px', overflow: 'hidden' }}>
          {[
            ...
            >
              <div style={{ width: '120px', flexShrink: 0, fontWeight: 600, color: '#555', fontSize: '0.9rem' }}>
                {label}
              </div>
